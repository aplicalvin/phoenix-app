<x-layout>
    ...
    {{-- Product Item Start --}}
    <div class="grid md:flex gap-4 md:gap-8 p-8" style="border: 1px solid red;">
        <div class="w-50% border-8 border-gray-500">
            <img src="{{asset('asset/image/dummy1.jpg')}}" class="object-cover w-full  h-64 md:h-full md:max-w-2xl">
        </div>
