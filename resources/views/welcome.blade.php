<x-layout>
    ...
    <div class="py-10 px-10 bg-slate-800">
        ...
        <div class="grid lg:flex gap-8 my-8 mx-auto">
            ...
            {{-- Identitas bg --}}
            <div  class="grid gap-3 h-fit my-10 text-gray-300">
                ...
                <div class="grid gap-1">
                    <a href="tel:+628170553367" target="_blank" class="flex gap-2"><i class="bi bi-telephone-fill"></i>08170553367</a>
                    <a href="mailto: phoenix@gmail.com" target="_blank" class="flex gap-2"> <i class="bi bi-envelope-fill" ></i>phoenix@gmail.com</a>
                </div>
