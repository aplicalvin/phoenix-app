        ...
        <div class="w-full h-fit bg-black/70">
            ...
            <div class="mx-8 lg:mx-auto max-w-6xl py-12">
                <div class="grid gap-5 py-6">
                    <h1 class="text-white text-center font-bold text-4xl">Layanan Kami</h1>
                    {{-- Search --}}
                    <div class="w-4/5 md:w-3/5 mx-auto">
                        <form class="flex items-center">   
                            <label for="simple-search" class="sr-only">Cari Layanan</label>
                            <div class="relative w-full">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    
                                </div>
                                <input type="text" id="simple-search" class="bg-stone-200 border border-stone-300 text-stone-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  " placeholder="Cari Layanan" required>
                            </div>
